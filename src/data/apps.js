export const apps = [
  {
    ...
    highlights: [
      ...
      'Customizable sources & topics',
      'Hourly audio newscasts',
      'iPhone, iPad & Apple Watch',
    ],
    meta: '4.7 ★ on the App Store',
    accent: 'from-rose-500 to-orange-500',
    badge: 'News',
    links: {
      web: 'https://breaking.iavian.net',
      ios: 'https://apps.apple.com/in/app/breaking-news/id398269756',
      android:
        'https://play.google.com/store/apps/details?id=instant.breaking.news.free',
    },
  },
  {
    id: 'the-report',
    ...
    highlights: [
      ...
      'Customizable conservative sources',
      'Bookmarks & Spotlight search',
      'iOS Lock Screen widget',
    ],
    meta: '5.0 ★ on the App Store',
    accent: 'from-blue-600 to-indigo-600',
    badge: 'News',
    links: {
      web: 'https://thereport.be',
      ios: 'https://apps.apple.com/in/app/conservative-news-the-report/id1162108244',
      android:
        'https://play.google.com/store/apps/details?id=the.report.us.free',
    },
  },
  {
    ...
    meta: 'Runs entirely on your device',
    accent: 'from-emerald-500 to-teal-500',
    badge: 'Productivity',
    links: {
      web: 'https://pdftableconvert.com/',
    },
  },
]
